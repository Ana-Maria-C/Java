...
Repository:
    ...
    EntityManagerFactorySingleton
        ...
        -> responsabilă cu crearea și gestionarea unui obiect EntityManagerFactory
        ->  garantează că o singură instanță a unei clase este creată și este accesibilă din întreaga aplicație.
        -> metoda  getInstance() este utilizată pentru a obține o instanță a EntityManagerFactorySingleton. Această metodă verifică dacă instanța este deja creată, iar dacă nu este, o creează prin intermediul metodei Persistence.createEntityManagerFactory() și o returnează.
        -> metoda closeEntityManagerFactory() este folosită pentru a închide EntityManagerFactory, dacă este deschis.
        -> in cadrul clasei AbstractRepository, EntityManagerFactorySingleton este folosită pentru a crea un obiect EntityManager, care este necesar pentru a efectua operațiile pe baza de date, precum persistența sau căutarea obiectelor.